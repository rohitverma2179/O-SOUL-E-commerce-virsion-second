      ...
      <div className="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        <div className="p-4 border-b border-slate-50 flex flex-col md:flex-row gap-4 items-center justify-between bg-slate-50/30">
          <div className="relative w-full md:w-96">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 rounded-lg border border-slate-200 focus:ring-2 focus:ring-olive/20 focus:border-olive text-sm transition-all"
            />
          </div>
          {/* <div className="flex items-center gap-2 w-full md:w-auto">
            ...
            <select className="px-3 py-2 rounded-lg border border-slate-200 text-sm font-medium text-slate-600 focus:ring-2 focus:ring-olive/20 outline-none w-full md:w-auto">
                ...
                <tr key={user.id} className="hover:bg-slate-50/50 transition-colors group">
                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-1.5 font-medium">
                      <Shield size={14} className={user.role === 'Super Admin' ? 'text-purple-500' : 'text-olive'} />
        ...
        <div className="p-4 border-t border-slate-50 flex items-center justify-between text-sm text-slate-500 bg-slate-50/20">
          ...
          <div className="flex gap-2">
            ...
            <button className="px-3 py-1 rounded bg-olive text-white font-medium">1</button>
